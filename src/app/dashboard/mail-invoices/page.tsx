    ...
    <div>
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="text-muted text-sm mb-4">
          ...
          W tabeli możesz: <strong>edytować numer faktury</strong> (kliknij numer przy fakturze z maila), <strong>edytować datę</strong> (kliknij datę przy fakturze z maila), <strong>edytować dostawcę</strong> (kliknij nazwę dostawcy) lub <strong>przypisać kontrahenta z bazy</strong> (dropdown), oraz <strong>ustawić jako opłaconą</strong> (checkbox w kolumnie „Rozliczono”).
          Kliknij „Szczegóły” przy fakturze, aby zobaczyć treść maila, załączniki, zmienić numer, datę lub dostawcę, przypisać kontrahenta lub oznaczyć płatność.
        </p>
